# OpenCloudCX Anchore Module

Using this module within OpenCloudCX will provision an anchore engine instance. This module can be used in multiple environments depending on the providers and DNS zones being defined. It is a good idea to have all modules, providers, and namespace creation in the same file.
...
|---|---|---|---|
|Anchore Engine| ```https://anchore.[DNS ZONE]```|None|AWS Secrets Manager [```anchore```]|
